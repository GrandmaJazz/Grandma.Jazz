  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "telepathic-black": "hsl(var(--telepathic-black))",
        "telepathic-white": "hsl(var(--telepathic-white))",
        "telepathic-orange": "hsl(var(--telepathic-orange))",
        "telepathic-beige": "hsl(var(--telepathic-beige))",
        "telepathic-green": "hsl(var(--telepathic-green))",
      },
      borderRadius: {
        lg: "var(--radius)",
