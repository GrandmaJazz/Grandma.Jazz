...
interface HeroSectionProps {
  ...
  onInit?: () => void;
  loading?: boolean;
  isLoadingModel?: boolean; // prop ใหม่เพื่อบอกว่าเริ่มโหลดโมเดลหรือยัง
...
const HeroSection: React.FC<HeroSectionProps> = ({ 
  ...
  // เพิ่ม state เพื่อติดตามว่าโมเดลโหลดเสร็จแล้วหรือยัง
  ...
  // Effect เดียวสำหรับการจัดการ client-side mounting
  useEffect(() => {
