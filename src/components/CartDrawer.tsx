      ...
      >
        ...
        <div className="flex flex-col h-full relative">
          ...
          <div className="flex justify-between items-center p-4 border-b border-[#7c4d33]/30">
            <h2 className="text-xl font-suisse-intl-mono uppercase text-[#b88c41]">
                  ...
                  return (
                    <div key={item.productId} className="flex border-b border-[#7c4d33]/30 pb-4">
                      ...
                      <div className="ml-4 flex-1">
                        ...
                        <p className="text-[#b88c41] text-sm font-suisse-intl-mono">
                        ...
                        <div className="flex items-center mt-2">
                          <button 
                            ...
                            className="w-8 h-8 flex items-center justify-center border border-[#7c4d33]/50 text-[#e3dcd4] hover:border-[#b88c41] hover:text-[#b88c41] rounded-l-lg transition-colors"
                          ...
                          <button 
                            onClick={(e) => handleUpdateQuantity(e, item.productId, item.quantity + 1)}
                            className="w-8 h-8 flex items-center justify-center border border-[#7c4d33]/50 text-[#e3dcd4] hover:border-[#b88c41] hover:text-[#b88c41] rounded-r-lg transition-colors"
                            disabled={product.isOutOfStock}
                          >
                            +
                          </button>
