        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-10 xl:gap-16">
          ...
          >
            ...
            <Link
              ...
              className="inline-block px-6 sm:px-8 py-3 sm:py-4 bg-[#D4AF37] rounded-full text-black font-bold text-base sm:text-lg transition-transform hover:scale-105 active:scale-95 mb-8"
            >
