                  ...
                  <div className="relative">
                    ...
                    {isProfileDropdownOpen && (
                      <div 
                        ...
                        className="absolute right-0 mt-3 w-56 bg-gradient-to-br from-[#0A0A0A]/95 to-[#181818]/95 backdrop-blur-xl border border-[#B49B73]/20 rounded-2xl shadow-2xl shadow-[#B49B73]/10 py-2 z-50 animate-in slide-in-from-top-2 duration-200"
                        style={{
