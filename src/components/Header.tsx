...
export function Header() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center">
      ...
      {!isMobileMenuOpen && (
        <header 
          className={`flex items-center justify-between max-w-6xl w-11/12 py-5 px-10 rounded-b-3xl bg-gradient-to-r from-[#0A0A0A]/95 via-[#1a1a1a]/95 to-[#0A0A0A]/95 backdrop-blur-xl border border-[#B49B73]/20 text-white transition-all duration-700 ease-out shadow-2xl shadow-[#B49B73]/10 ${
        ...
        >
          {isMobile ? (
            ...
            <>
              <button 
                className="z-10 p-2 rounded-xl bg-[#B49B73]/10 border border-[#B49B73]/20 transition-all duration-300 ease-out hover:bg-[#B49B73]/20 hover:scale-110 hover:rotate-180 active:scale-95"
                onClick={handleToggleMenu}
                aria-label="Toggle menu"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#B49B73]">
              ...
              <div className="z-10 flex items-center">
                ...
                >
                  <div className="relative p-2 rounded-xl bg-[#B49B73]/10 border border-[#B49B73]/20 transition-all duration-300 group-hover:bg-[#B49B73]/20 group-hover:scale-110 group-active:scale-95">
            ...
            <>
              ...
              <div className="flex items-center space-x-6">
                {isAuthenticated ? (
                  <div className="relative">
                    <button 
                      ...
                      className="group flex items-center space-x-3 px-4 py-2 rounded-xl bg-[#B49B73]/10 border border-[#B49B73]/20 transition-all duration-300 hover:bg-[#B49B73]/20 hover:scale-105 hover:shadow-lg hover:shadow-[#B49B73]/20"
                    >
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#B49B73] transition-transform duration-300 group-hover:rotate-180">
                    ...
                    {isProfileDropdownOpen && (
                      <div 
                        ...
                        className="absolute right-0 mt-3 w-56 bg-gradient-to-br from-[#0A0A0A]/95 to-[#1a1a1a]/95 backdrop-blur-xl border border-[#B49B73]/20 rounded-2xl shadow-2xl shadow-[#B49B73]/10 py-2 z-50 animate-in slide-in-from-top-2 duration-200"
                        style={{
                ...
                <button 
                  onClick={() => setIsCartOpen(true)}
                  className="group relative p-3 rounded-full bg-[#B49B73]/10 border border-[#B49B73]/20 transition-all duration-300 hover:bg-[#B49B73]/20 hover:scale-110"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#B49B73]">
                    <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path>
                    <line x1="3" y1="6" x2="21" y2="6"></line>
      ...
      {(isMobileMenuOpen || isMenuTransitioning) && (
        <header 
          className={`max-w-6xl w-11/12 rounded-b-3xl bg-gradient-to-br from-[#0A0A0A]/95 via-[#1a1a1a]/95 to-[#0A0A0A]/95 backdrop-blur-xl border border-[#B49B73]/20 text-white transition-all duration-500 ease-out shadow-2xl shadow-[#B49B73]/15 ${
          ...
          <div className="py-8 px-10 flex flex-col">
            ...
            <div className="flex justify-between items-center">
              <button 
                ...
                className="p-3 rounded-full bg-[#B49B73]/10 border border-[#B49B73]/20 text-[#B49B73] transition-all duration-300 hover:bg-[#B49B73]/20 hover:rotate-90 hover:scale-110"
              >
