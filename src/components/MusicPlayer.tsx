  ...
  return (
    ...
    >
      <div className={`relative ${isExpanded ? 'w-full max-w-xl' : 'w-auto'}`}>
        ...
        `}>
          ...
          <div className="flex items-center flex-shrink-0" onClick={() => setIsExpanded(!isExpanded)}>
            ...
            <div className="relative flex-shrink-0">
              <button
                ...
                className={`
                  ...
                  hover:ring-4 hover:ring-[#B49B73]/30
                `}
                title="Playlist"
              >
                <img 
            ...
            {!isExpanded && (
              <button 
                className="ml-1 sm:ml-2 text-[#e3dcd4]/70 hover:text-[#e3dcd4] active:text-[#e3dcd4] active:scale-95"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  setIsExpanded(true);
            ...
            {isExpanded && (
              ...
              >
                ...
                <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-3">
                  <button 
                    className="p-1 md:p-2 text-[#e3dcd4]/80 hover:text-[#e3dcd4] transition-colors rounded-full hover:bg-[#7c4d33]/20 active:bg-[#7c4d33]/40 active:scale-95"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      previousTrack();
                  ...
                  <button 
                    className="p-1.5 sm:p-2 text-[#0A0A0A] bg-[#B49B73] hover:bg-[#7c4d33] rounded-full transition-colors flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 active:scale-95"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                  ...
                  <button 
                    className="p-1 sm:p-1.5 text-[#e3dcd4]/80 hover:text-[#e3dcd4] transition-colors rounded-full hover:bg-[#7c4d33]/20 active:bg-[#7c4d33]/40 active:scale-95"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      toggleMute();
                  ...
                  <button 
                    className="ml-1 sm:ml-2 p-1 md:p-1.5 text-[#e3dcd4]/70 hover:text-[#e3dcd4] transition-colors rounded-full hover:bg-[#7c4d33]/20 active:bg-[#7c4d33]/40 active:scale-95"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      setIsExpanded(false);
      ...
      <style jsx global>{`
        ...
        .shadow-glow {
          box-shadow: 0 0 8px 2px rgba(180, 155, 115, 0.3);
        }
      `}</style>
    </motion.div>
  );
