      ...
      <AnimatedSection animation="fadeIn" className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            ...
            >
              <span className="text-[#F5F1E6]">Ticket</span> <span className="text-[#b88c41]">Checkout</span>
            </h1>
            <div className="h-0.5 w-6 bg-[#b88c41]/30 ml-4"></div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <h2 className="text-2xl font-suisse-intl text-[#F5F1E6] mb-6 flex items-center">
              <Ticket className="text-[#b88c41] mr-2" size={24} />
              Ticket Details
            </h2>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-[#e3dcd4]">
                  <Calendar className="text-[#b88c41]" size={20} />
                  <span>{formatDate(ticket.event.eventDate)}</span>
                </div>

                <div className="flex items-center gap-3 text-[#e3dcd4]">
                  <MapPin className="text-[#b88c41]" size={20} />
                  <span>Grandma Jazz Venue, Phuket</span>
                </div>

                <div className="flex items-center gap-3 text-[#e3dcd4]">
                  <Users className="text-[#b88c41]" size={20} />
          ...
          >
            ...
            <h2 className="text-2xl font-suisse-intl text-[#F5F1E6] mb-6 flex items-center">
              <CreditCard className="text-[#b88c41] mr-2" size={24} />
              Payment Summary
            </h2>
              ...
              <div className="space-y-3">
                ...
                <div className="border-t border-[#7c4d33]/30 pt-3">
                  <div className="flex justify-between text-[#F5F1E6] font-semibold text-lg">
                    ...
                    <span className="text-[#b88c41]">${ticket.totalAmount.toLocaleString()}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                {isEventPassed(ticket.event.eventDate) ? (
                  ...
                  <Button
                    ...
                    fullWidth
                    rounded="full"
                    className="border-[#b88c41]/50 hover:bg-[#b88c41]/10 shadow-lg py-4 text-lg"
                  >
