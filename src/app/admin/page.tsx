  ...
  return (
    <div>
      <h1 className="text-4xl font-editorial-ultralight text-[#F5F1E6] mb-8">
        Dashboard <span className="text-[#b88c41]">Overview</span>
      </h1>
      ...
      <AnimatedSection animation="fadeIn" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div className="bg-[#31372b] p-6 rounded-3xl shadow-md relative">
          ...
          <Link href="/admin/products" className="text-[#b88c41] text-sm hover:underline mt-3 inline-block">
            Manage Products
          </Link>
        </div>
        ...
        <div className="bg-[#7c4d33] p-6 rounded-3xl shadow-md relative">
          ...
          <Link href="/admin/orders" className="text-[#b88c41] text-sm hover:underline mt-3 inline-block">
            View All Orders
          </Link>
        </div>
      ...
      <AnimatedSection animation="fadeIn" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div className="bg-[#0A0A0A] border border-[#7c4d33]/30 p-6 rounded-3xl shadow-md relative">
          ...
          <Link href="/admin/blogs" className="text-[#b88c41] text-sm hover:underline mt-3 inline-block">
            Manage Blogs
          </Link>
        </div>
        ...
        {/* Total Views */}
        <div className="bg-[#b88c41]/10 border border-[#b88c41]/30 p-6 rounded-3xl shadow-md relative">
          <div className="flex justify-between items-center mb-4 relative">
          ...
          <div className="text-[#b88c41] text-sm mt-3">
            Blog views
          </div>
        </div>
      </AnimatedSection>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-10">
        ...
        <AnimatedSection animation="fadeIn">
          <div className="bg-[#0A0A0A] rounded-lg border border-[#31372b] overflow-hidden shadow-lg">
            ...
            <div className="p-4 border-t border-[#31372b] text-center">
              <Link href="/admin/orders" className="text-[#b88c41] hover:text-[#b88c41] transition-colors text-sm">
                View All Orders
              </Link>
            </div>
          </div>
        ...
        <AnimatedSection animation="fadeIn">
          <div className="bg-[#0A0A0A] rounded-lg border border-[#31372b] overflow-hidden shadow-lg">
            ...
            <div className="p-4 border-t border-[#31372b] text-center">
              <Link href="/admin/blogs" className="text-[#b88c41] hover:text-[#b88c41] transition-colors text-sm">
                View All Blogs
              </Link>
            </div>
          </div>
      ...
      <AnimatedSection animation="fadeIn">
        <div className="bg-[#0A0A0A] rounded-lg border border-[#31372b] p-6 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-3 text-[#b88c41]">
