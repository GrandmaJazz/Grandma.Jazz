    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h1 className="text-3xl font-editorial-ultralight text-[#F5F1E6]">
          Order <span className="text-[#b88c41]">Details</span>
        </h1>
                  ...
                  {order.orderItems.map((item, index) => (
                    <div key={item._id || index} className="flex flex-col sm:flex-row items-start sm:items-center py-3 border-b border-[#7c4d33]/20 last:border-b-0">
                      ...
                      <div className="flex-1 min-w-0">
                        <Link href={`/admin/products/${item.product._id}`} className="text-[#F5F1E6] hover:text-[#b88c41] transition-colors font-medium">
                          {item.product.name}
                        </Link>
                      ...
                      <div className="text-[#b88c41] font-suisse-intl-mono mt-2 sm:mt-0">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#0A0A0A] border border-[#7c4d33]/50 rounded-xl p-3 text-[#F5F1E6] focus:border-[#b88c41] focus:outline-none focus:ring-1 focus:ring-[#b88c41]"
