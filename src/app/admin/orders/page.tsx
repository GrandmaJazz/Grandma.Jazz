    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h1 className="text-3xl font-editorial-ultralight text-[#F5F1E6]">
          Orders <span className="text-[#B49B73]">Management</span>
        </h1>
      </div>
                      ...
                      <tr key={order._id} className="border-b border-[#7c4d33]/30 hover:bg-[#7c4d33]/10 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <Link 
                            ...
                            className="text-[#B49B73] hover:text-[#B49B73] transition-colors"
                          >
                            Manage
                          </Link>
                        </td>
                  ...
                  {orders.map((order) => (
                    <div key={order._id} className="bg-[#181818] p-4 rounded-box border border-[#7c4d33]/30">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="text-[#B49B73] font-suisse-intl-mono font-medium">
                          ${formatPrice(order.totalAmount)}
                        </div>
                      </div>
                      ...
                      <div className="mt-3 pt-3 border-t border-[#7c4d33]/30 flex justify-end">
                        <Link 
                          href={`/admin/orders/${order._id}`}
                          className="text-[#B49B73] hover:text-[#B49B73] transition-colors flex items-center"
                        >
