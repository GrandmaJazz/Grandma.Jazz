        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            <h1 className="text-4xl md:text-5xl font-editorial-ultralight text-[#F5F1E6]">
              Manage <span className="text-[#b88c41]">Events</span>
            </h1>
          ...
          <button
            ...
            className="bg-[#b88c41] hover:bg-[#b88c41] text-[#0A0A0A] py-2.5 px-5 rounded-full transition-colors duration-300 font-suisse-intl-mono text-sm uppercase tracking-wider flex items-center gap-2"
          >
            <Plus size={18} />
            Add New Event
          </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-[#31372b] border border-[#7c4d33]/30 rounded-lg focus:outline-none focus:border-[#b88c41] text-[#F5F1E6] placeholder-[#e3dcd4]/60"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 bg-[#31372b] border border-[#7c4d33]/30 rounded-lg focus:outline-none focus:border-[#b88c41] h-32 resize-none text-[#F5F1E6] placeholder-[#e3dcd4]/60"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-[#31372b] border border-[#7c4d33]/30 rounded-lg focus:outline-none focus:border-[#b88c41] text-[#F5F1E6]"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-[#31372b] border border-[#7c4d33]/30 rounded-lg focus:outline-none focus:border-[#b88c41] text-[#F5F1E6] file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-medium file:bg-[#b88c41] file:text-[#0A0A0A] hover:file:bg-[#b88c41]"
                />
              ...
              <div className="flex gap-4 pt-4">
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 bg-[#b88c41] hover:bg-[#b88c41] text-[#0A0A0A] py-3 rounded-lg font-suisse-intl-mono text-sm uppercase tracking-wider transition-all duration-300 disabled:opacity-50"
                >
