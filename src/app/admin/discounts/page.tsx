  ...
  return (
    <div>
      ...
      <AnimatedSection animation="fadeIn" className="space-y-4">
        {discounts.length === 0 ? (
          <div className="bg-[#181818]/70 backdrop-blur-sm p-8 rounded-box border border-[#7c4d33]/20 text-center">
          ...
          discounts.map((discount) => (
            <div
              key={discount._id}
              className="bg-[#181818]/70 backdrop-blur-sm p-6 rounded-box border border-[#7c4d33]/20"
            >
      ...
      {showModal && (
        ...
        >
          <div
            className="bg-[#181818] border border-[#B49B73]/30 rounded-box p-8 max-w-2xl w-full shadow-2xl"
