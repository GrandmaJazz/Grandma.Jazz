    ...
    <div>
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-editorial-ultralight text-[#F5F1E6]">
          Discount <span className="text-[#b88c41]">Management</span>
        </h1>
        <Button
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                    <h3 className="text-2xl font-suisse-intl-mono text-[#b88c41]">
                      {discount.code}
                    </h3>
                    <span
                    ...
                    <span className="px-3 py-1 rounded-full text-xs font-suisse-intl-mono bg-[#b88c41]/20 text-[#b88c41]">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-[#e3dcd4]/80 font-suisse-intl">
                    <div>
                      <span className="text-[#b88c41]">Valid From:</span> {formatDate(discount.validFrom)}
                    </div>
                    {discount.validUntil && (
                      <div>
                        <span className="text-[#b88c41]">Valid Until:</span> {formatDate(discount.validUntil)}
                      </div>
                    )}
                    <div>
                      <span className="text-[#b88c41]">Used By:</span> {discount.usedBy.length} user(s)
                    </div>
                    <div>
                      <span className="text-[#b88c41]">Created:</span> {formatDate(discount.createdAt)}
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-2 ml-4">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="border-[#b88c41]/50 hover:bg-[#b88c41]/10"
                  >
                    Edit
                  </Button>
                  <Button
      ...
      {showModal && (
        ...
        >
          <div
            className="bg-[#1a1a1a] border border-[#b88c41]/30 rounded-3xl p-8 max-w-2xl w-full shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <h2 className="text-2xl font-editorial-ultralight text-[#b88c41] mb-6">
              {editingDiscount ? 'Edit Discount' : 'Create New Discount'}
            </h2>
            
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-[#b88c41] text-sm font-suisse-intl-mono mb-2 uppercase tracking-wider">
                  Discount Code
                </label>
                <Input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="bg-[#0A0A0A]/50 border border-[#7c4d33]/50 text-[#F5F1E6] rounded-xl px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-[#b88c41] font-suisse-intl"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="bg-[#0A0A0A]/50 border border-[#7c4d33]/50 text-[#F5F1E6] rounded-xl px-4 py-3 w-full focus:outline-none focus:ring-2 focus:ring-[#b88c41] font-suisse-intl min-h-[100px]"
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 text-[#b88c41] bg-[#0A0A0A] border-[#7c4d33]/50 rounded focus:ring-[#b88c41]"
                />
              ...
              <div className="flex gap-3 mt-6">
                <Button
                  type="submit"
                  className="flex-1 bg-[#b88c41] hover:bg-[#b88c41]/90 text-[#0A0A0A] font-suisse-intl-mono"
                >
