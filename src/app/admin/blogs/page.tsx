      ...
      <AnimatedSection animation="fadeIn">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <h1 className="text-4xl md:text-5xl font-editorial-ultralight text-[#F5F1E6]">
            Manage <span className="text-[#b88c41]">Blogs</span>
          </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          ...
          <div className="relative">
            <input
              ...
              className="bg-[#31372b] border border-[#7c4d33]/30 rounded-full px-4 py-2 text-[#F5F1E6] placeholder-[#e3dcd4]/60 focus:border-[#b88c41] focus:outline-none w-64"
            />
                          ...
                          {blog.tags.length > 0 && (
                            <div className="flex flex-wrap gap-1 mt-2">
                              {blog.tags.slice(0, 3).map((tag, index) => (
                                <span
                                  key={index}
                                  className="px-2 py-1 text-xs bg-[#7c4d33]/20 text-[#b88c41] rounded-full"
                                >
                                  {tag}
                                </span>
                              ))}
