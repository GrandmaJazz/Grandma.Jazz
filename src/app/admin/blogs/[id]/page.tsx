      ...
      <AnimatedSection animation="fadeIn" className="mb-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <h1 className="text-4xl md:text-5xl font-editorial-ultralight text-[#F5F1E6]">
            {isEditMode ? 'Edit' : 'Create'} <span className="text-[#b88c41]">Blog</span>
          </h1>
            ...
            <div className="p-6 space-y-8">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#31372b] border border-[#7c4d33]/30 rounded-lg px-4 py-3 text-[#F5F1E6] placeholder-[#e3dcd4]/60 focus:border-[#b88c41] focus:outline-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-[#31372b] border border-[#7c4d33]/30 rounded-lg px-4 py-3 text-[#F5F1E6] placeholder-[#e3dcd4]/60 focus:border-[#b88c41] focus:outline-none resize-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#31372b] border border-[#7c4d33]/30 rounded-lg px-4 py-3 text-[#F5F1E6] placeholder-[#e3dcd4]/60 focus:border-[#b88c41] focus:outline-none resize-none overflow-hidden"
                    ...
                    {imagePreviews.map((preview, index) => (
                      <div key={index} className="relative group">
                        ...
                        <input
                          ...
                          className="w-full mt-2 bg-[#31372b] border border-[#7c4d33]/30 rounded px-3 py-2 text-[#F5F1E6] placeholder-[#e3dcd4]/60 focus:border-[#b88c41] focus:outline-none text-sm"
                        />
                      </div>
                    ))}
                  </div>
