    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h1 className="text-3xl font-editorial-ultralight text-[#F5F1E6]">
          Products <span className="text-[#B49B73]">Management</span>
        </h1>
                    ...
                    {products.map((product) => (
                      <tr key={product._id} className="border-b border-[#7c4d33]/30 hover:bg-[#7c4d33]/10 transition-colors">
                        ...
                        <td className="px-6 py-4 text-[#e3dcd4] font-suisse-intl-mono">
                          {product.weight ? product.weight.toFixed(2) : '0'} kg
                        </td>
                        <td className="px-6 py-4">
                          <button
                        ...
                        <td className="px-6 py-4">
                          <div className="flex space-x-2">
                            <Link 
                              ...
                              className="text-[#e3dcd4] hover:text-[#B49B73] transition-colors"
                            >
                    ...
                    <div key={product._id} className="bg-[#181818] p-4 rounded-2xl border border-[#7c4d33]/30">
                      <div className="flex items-center mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[#B49B73] font-suisse-intl-mono">${formatPrice(product.price)}</p>
                      ...
                      <div className="flex justify-between mt-3 pt-3 border-t border-[#7c4d33]/30">
                        <Link 
                          href={`/admin/products/${product._id}/edit`}
                          className="text-[#e3dcd4] hover:text-[#B49B73] transition-colors flex items-center"
                        >
