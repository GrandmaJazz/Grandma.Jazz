...
export default function AdminEditProductPage() {
  ...
  const validateForm = () => {
    ...
    } else if (isNaN(Number.parseFloat(formData.weight)) || Number.parseFloat(formData.weight) <= 0 || Number.parseFloat(formData.weight) > 30) {
      newErrors.weight = 'Weight must be between 0 and 30 kg';
    }
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-editorial-ultralight text-[#F5F1E6]">
          <span className="text-[#B49B73]">Edit</span> Product
        </h1>
