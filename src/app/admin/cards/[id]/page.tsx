        ...
        <AnimatedSection animation="fadeIn" className="mb-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <h1 className="text-4xl md:text-5xl font-editorial-ultralight text-[#F5F1E6]">
              {isEditMode ? 'Edit' : 'Add'} <span className="text-[#B49B73]">Music Card</span>
            </h1>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="p-6 space-y-8">
                ...
                <div className="pt-6 border-t border-[#7c4d33]/30">
                  ...
                  {/* New Music Files */}
                  <div>
                    <h3 className="text-[#B49B73] text-lg font-suisse-intl-mono uppercase tracking-wider mb-4">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-4 items-center">
                        <button
                          ...
                          className="px-5 py-2.5 rounded-full bg-[#B49B73] text-[#0A0A0A] hover:bg-[#B49B73] transition-colors duration-300 shadow-lg shadow-[#B49B73]/20 text-sm font-suisse-intl-mono uppercase tracking-wider"
                        >
                          Select Music Files
                        </button>
                    ...
                    {musicFiles.length > 0 && (
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                        {musicFiles.map((file, index) => (
                          <div 
                            key={index} 
                            className="flex justify-between items-center p-4 bg-[#B49B73]/10 rounded-box border border-[#B49B73]/30 hover:border-[#B49B73]/50 transition-colors duration-300"
                          >
                            <div className="flex-1 min-w-0">
                              <div className="text-[#F5F1E6] font-suisse-intl truncate pr-4">{file.name}</div>
                              <div className="text-xs text-[#B49B73] font-suisse-intl-mono mt-1">
