    ...
    <div className="min-h-screen pt-28 pb-16 bg-[#0A0A0A]">
      ...
      <AnimatedSection animation="fadeIn" className="max-w-4xl mx-auto px-6">
        <div className="flex items-center mb-8">
          <div className="h-0.5 w-12 bg-[#b88c41]/30 mr-6"></div>
          <h1 
          ...
          <div className="h-0.5 flex-1 bg-[#b88c41]/10 ml-6"></div>
        </div>
        
        {orders.length === 0 ? (
          <div className="bg-[#0A0A0A] border border-[#7c4d33]/30 p-10 rounded-3xl text-center shadow-lg backdrop-blur-sm">
            <div className="w-24 h-24 mx-auto mb-6 flex items-center justify-center rounded-full bg-[#0A0A0A] border border-[#b88c41]/20">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-12 h-12 text-[#b88c41]">
          ...
          <div className="space-y-8">
            {orders.map((order, index) => (
              <div 
                key={order._id} 
                className="bg-[#1a1a1a]/70 backdrop-blur-sm border border-[#7c4d33]/20 rounded-3xl overflow-hidden shadow-lg transition-all duration-300 hover:border-[#b88c41]/30"
                style={{ 
              ...
              >
                ...
                <div className="bg-[#0A0A0A]/50 p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-[#7c4d33]/20">
                  <div>
                    <div className="text-[#b88c41] text-xs font-suisse-intl-mono mb-1 uppercase tracking-wider">
                ...
                <div className="p-6">
                      ...
                      <div key={item.product} className="flex">
                        ...
                        <div className="ml-4 flex-1">
                          <div className="flex justify-between mb-2">
                            ...
                            <span className="text-[#b88c41] text-base font-suisse-intl-mono">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-t border-[#7c4d33]/20 pt-5">
                    <div className="text-[#F5F1E6] font-suisse-intl-mono mb-4 sm:mb-0">
                      Total: <span className="text-[#b88c41] text-lg">${formatPrice(order.totalAmount)}</span>
                    </div>
