    ...
    <div className="min-h-screen pt-28 pb-16 bg-[#0A0A0A]">
      <AnimatedSection animation="fadeIn" className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-6 text-[#e3dcd4] text-sm">
          <Link href="/products" className="hover:text-[#b88c41] transition-colors">
            Products
          </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="aspect-square relative rounded-3xl overflow-hidden bg-[#0A0A0A] border border-[#7c4d33]/30">
              ...
              {product.isFeatured && !product.isOutOfStock && (
                <div className="absolute top-4 left-4 z-10">
                  <span className="bg-[#b88c41] px-4 py-1 text-[#0A0A0A] text-sm font-bold uppercase font-suisse-intl-mono rounded-full">
                    Featured
                  </span>
                </div>
              )}
                ...
                {product.images.map((image, index) => (
                  <button
                    ...
                    className={`w-20 h-20 relative rounded-xl overflow-hidden flex-shrink-0 transition-all duration-300 ${
                      selectedImage === index 
                        ? 'ring-2 ring-[#b88c41] opacity-100 scale-105' 
          ...
          <div className="text-[#F5F1E6]">
            ...
            <div className="text-2xl font-suisse-intl-mono text-[#b88c41] mb-6">${formatPrice(product.price)}</div>
            ...
            <div className="mb-6">
              ...
              <div className="flex">
                <button 
                  ...
                  className="w-10 h-10 flex items-center justify-center border border-[#7c4d33]/50 text-[#e3dcd4] hover:border-[#b88c41] hover:text-[#b88c41] rounded-l-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  -
                </button>
                ...
                <button 
                  ...
                  disabled={product.isOutOfStock}
                  className="w-10 h-10 flex items-center justify-center border border-[#7c4d33]/50 text-[#e3dcd4] hover:border-[#b88c41] hover:text-[#b88c41] rounded-r-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  +
                </button>
              </div>
