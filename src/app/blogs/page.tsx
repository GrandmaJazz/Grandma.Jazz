...
const CARD_COLORS = ['#e3dcd4', '#31372b', '#7c4d33', '#B49B73'] as const;
...
const CardImage = ({ post, className }: { post: BlogPost; className: string }) => (
  <div className={className}>
    {post.images?.length > 0 ? (
      ...
      <div className="w-full h-full bg-gradient-to-br from-[#F5F1E6]/20 to-[#B49B73]/20 flex items-center justify-center">
