            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-3 text-[#e3dcd4] font-suisse-intl-mono text-sm">
                  <Calendar className="text-[#B49B73]" size={18} />
                  <span>{formatDate(event.eventDate)}</span>
                </div>

                <div className="flex items-center gap-3 text-[#e3dcd4] font-suisse-intl-mono text-sm">
                  <MapPin className="text-[#B49B73]" size={18} />
                  ...
                  <div className="space-y-2">
                    ...
                    {!event.isSoldOut && (
                      <div className="w-full bg-[#7c4d33]/30 rounded-full h-2">
                        <div 
                          className="bg-[#B49B73] h-2 rounded-full transition-all duration-300"
          ...
          <AnimatedSection animation="fadeIn">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {/* Quantity Selection */}
                <div>
                  <label className="block text-[#B49B73] font-suisse-intl text-sm uppercase tracking-wider mb-3">
                  ...
                  {isEventPassed(event.eventDate) ? (
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-2xl font-suisse-intl text-[#B49B73] min-w-[3rem] text-center">
                        {quantity}
                      </span>
                      <button
                        type="button"
                ...
                {isEventPassed(event.eventDate) ? (
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full bg-[#B49B73] hover:bg-[#B49B73] text-[#0A0A0A] py-3 sm:py-4 rounded-xl font-suisse-intl-mono text-sm sm:text-base uppercase tracking-wide transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                  >
